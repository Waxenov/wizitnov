<x-guest-layout>
    ...
    <div class="min-h-screen flex flex-col items-center">
        <div class="w-full minimal:p-4 tablet:p-10">
            <!-- Heading -->
            <h3 class="tablet:text-4xl minimal:text-2xl font-big tracking-tight text-milano">Политика конфиденциальности</h3>
            <!-- Content -->
            <div class="tablet:pb-10 minimal:pb-4 pt-4">
                <div class="tablet:text-2xl minimal:text-xl text-coffee font-big">
                    <h1>Политика в отношении обработки персональных данных</h1>
                </div>
            </div>

            <div class="tablet:pb-10 minimal:pb-4">
                ...
                <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                    ...
                    данных, предпринимаемые Проектом Грузомагистр (далее — Оператор).
                </h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    ...
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                        ...
                        которую Оператор может получить о посетителях веб-сайта <a href="{{ route('welcome') }}" class="text-xl minimal:text-lg font-base text-milano hover:text-hipnymph">https://gruzomagister.ru</a>.
                    </h2>
                </div>
            </div>

            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">2. Основные понятия, используемые в Политике</h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                    ...
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                        ...
                        их доступность в сети интернет по сетевому адресу <a href="{{ route('welcome') }}" class="text-xl minimal:text-lg font-base text-milano hover:text-hipnymph">https://gruzomagister.ru</a>.
                    </h2>
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                    ...
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">2.8. Персональные данные — любая информация,
                        относящаяся прямо или косвенно к определенному или определяемому
                        Пользователю веб-сайта <a href="{{ route('welcome') }}" class="text-xl minimal:text-lg font-base text-milano hover:text-hipnymph">https://gruzomagister.ru</a>.
                    </h2>
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                    ...
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                        2.10. Пользователь — любой посетитель веб-сайта <a href="{{ route('welcome') }}" class="text-xl minimal:text-lg font-base text-milano hover:text-hipnymph">https://gruzomagister.ru</a>.
                    </h2>
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
            ...
            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">3. Основные права и обязанности Оператора</h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">3.1. Оператор имеет право:
                </div>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                    ...
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">3.2. Оператор обязан:</h2>
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
            ...
            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">4. Основные права и обязанности субъектов персональных данных</h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">4.1. Субъекты персональных данных имеют право:
                </div>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                    ...
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">4.2. Субъекты персональных данных обязаны:</h2>
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
            ...
            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">5. Принципы обработки персональных данных</h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
            ...
            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">6. Цели обработки персональных данных</h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                        Цель обработки:
                        Предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте
                    </h2>
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pt-4">
                        Персональные данные:
                        Фамилия, имя, отчество, электронный адрес, номера телефонов, фотографии, адреса погрузки и выгрузки грузов
                    </h2>
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pt-4">
                        Правовые основания:
            ...
            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">7. Условия обработки персональных данных</h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
            ...
            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">
                ...
                <div class="pt-4">
                    ...
                    <div class="tablet:ps-10 minimal:ps-0 pt-4">
                        ...
                        <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                            ...
                            Оператору уведомление на адрес электронной почты Оператора <span class="text-xl minimal:text-lg font-base text-milano">waxenov@mail.ru</span>
                        ...
                        <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                            ...
                            посредством электронной почты на электронный адрес Оператора <span class="text-xl minimal:text-lg font-base text-milano">waxenov@mail.ru</span>
            ...
            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">10. Трансграничная передача персональных данных</h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
            ...
            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">11. Конфиденциальность персональных данных</h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
            ...
            <div class="tablet:pb-10 minimal:pb-4">
                <h2 class="tablet:text-2xl minimal:text-xl text-coffee font-big">12. Заключительные положения</h2>
                <div class="tablet:ps-10 minimal:ps-0 pt-4">
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                        ...
                        к Оператору с помощью электронной почты <span class="text-xl minimal:text-lg font-base text-milano">waxenov@mail.ru</span>.
                    </h2>
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                    ...
                    <h2 class="tablet:text-xl minimal:text-lg text-coffee font-base pb-2">
                        ...
                        в сети Интернет по адресу <a href="{{ route('policy') }}" class="text-xl minimal:text-lg font-base text-milano hover:text-hipnymph">https://gruzomagister.ru/policy</a>.
                    </h2>
                </div>
            </div>
        </div>
